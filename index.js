...
addButton.addEventListener("click", (e)=>{productsQuantity+=1;
  quantity.innerHTML = productsQuantity;
  updateCounter()
  ...
  itemAdded.append(itemAddedName, itemAddedPrice, itemAddedIcon)

  bag.appendChild(itemAdded)

  itemAddedIcon.addEventListener("click", ()=>{itemAddedIcon.parentElement.remove()
  productsQuantity -=1
  updateCounter()
  quantity.innerHTML = productsQuantity
})
